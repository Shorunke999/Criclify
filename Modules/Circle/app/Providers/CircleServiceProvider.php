...
use Modules\Circle\Repositories\CircleInviteRepository;
...
use Modules\Circle\Repositories\CircleRepository;
use Modules\Circle\Repositories\ContributionRepository;
...
class CircleServiceProvider extends ServiceProvider
{
    ...
    protected string $nameLower = 'circle';
    ...
    public function register(): void
    {
        ...
        $this->app->bind(CircleRepositoryInterface::class, CircleRepository::class);
        $this->app->bind(CircleInviteRepositoryInterface::class, CircleInviteRepository::class);
